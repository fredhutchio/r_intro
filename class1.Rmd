---
title: 'Introduction to R, Class 1: Functions and objects'
...
you may also be interested in modifying and running code in the original R markdown file ([`class1.Rmd`](class1.Rmd) in the GitHub repository).
